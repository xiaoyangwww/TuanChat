package com.ywt.common.utils.discover;
...
public interface UrlDiscover {
    ...
    public static void main(String[] args) {
        ...
        stopWatch.start();
//        String longStr = "其中包含一个URL www.taobao.com,一个带有端口号的URL http://www.jd.com:80, 一个带有路径的URL http://mallchat.cn, 还有美团技术文章https://mp.weixin.qq.com/s/hwTf4bDck9_tlFpgVDeIKg ";
//        String longStr = "一个带有端口号的URL http://www.jd.com:80,";
        String longStr = "一个带有路径的URL www.ywt2001.fun";
