...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/ywt-chat-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("ywt");
        ...
        packageConfig.setParent("com.ywt.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("ywt20011");
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/chat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}
